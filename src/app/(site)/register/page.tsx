...
export const metadata = {
  ...
  description: "Войди через Twitch, укажи Embark ID и оставь заявку в общий пул участников.",
};

const STEPS = [
  { n: 1, title: "Вход через Twitch", text: "Авторизуйся — так мы свяжем заявку с твоим аккаунтом." },
  { n: 2, title: "Укажи Embark ID", text: "Ник вида «ник#0000» — он нужен для лобби в Arc Raiders." },
